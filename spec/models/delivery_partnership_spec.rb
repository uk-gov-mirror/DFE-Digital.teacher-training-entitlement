...
RSpec.describe DeliveryPartnership, type: :model do
  ...
  describe "validations" do
    ...
    it { is_expected.to validate_presence_of :course_cohort_id }
    ...
    describe "uniqueness" do
      ...
      it "delivery partner must be unique for a given lead provider and course cohort" do
        expect(subject).to validate_uniqueness_of(:delivery_partner_id).scoped_to(%i[lead_provider_id course_cohort_id])
      end
    end
  end
end
